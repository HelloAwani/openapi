...
namespace Service\Http\Controllers\OFNB\v1;
...
class Master extends \Service\Http\Controllers\_Heart
{
	...
	public function catalogue(){
		...
		$categories  = $this->query('SELECT "CategoryID", "Color", 
		...
		$menu = $this->query('SELECT "CategoryID", "MenuID", 
		...
		foreach($menu as $m){
			if(@$mc["c.".$m->CategoryID]!=null){
				...
				select mg."ModifierGroupID", mg."ModifierGroupName" , mi."ModifierItemID", mi."ModifierName" , mi."PriceModifier"  from "MenuModifier" mm 
